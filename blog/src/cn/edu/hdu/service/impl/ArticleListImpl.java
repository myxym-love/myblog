...
public class ArticleListImpl implements ArticleListService {
    ...
    @Override
    public PageBean<ArticleByName> findArticleByPage(String _currentPage, String _rows,String words) {
        ...
        PageBean<ArticleByName> pb = new PageBean<>();
        ...
        List<ArticleByName> list = dao.findByPage(start,rows,words);
        pb.setList(list);
        return  pb;
    }
