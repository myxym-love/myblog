...
public class UserDao {
    ...
    * */
    ...
    public int modifyUserInfo(User user) {
        ...
        return template.update(sql,user.getUsername(),user.getPassword(),user.getUser_email(),user.getUser_realname(),user.getUser_phone(),user.getUser_sex(),user.getUser_bir(),user.getId());
    }
}
